...
Bot de WhatsApp com painel web, envio manual, agendamento em horário de Brasília e backup manual da sessão no Supabase Storage.
...
Restrict MIME types: application/zip
```
